...
(function (angular) {
  ...
  angular.module('sun.rest.config', [ ])
    .provider('RestConfig', function () {
      ...
      return {
        $get                   : function RestConfig()
        /**
         * @name RestConfig
         * @constructor
         * @returns {{getStrictMode: getStrictMode, getBaseUrl: getBaseUrl, getResponseDataLocation: getResponseDataLocation, getModelIdProperty: getModelIdProperty, getUpdateMethod: getUpdateMethod, getRequestFormatter: getRequestFormatter, getFlattenItemRoute: getFlattenItemRoute, getValidateOnSync: getValidateOnSync, getIsArray: getIsArray, setStrictMode: setStrictMode, setBaseUrl: setBaseUrl, setResponseDataLocation: setResponseDataLocation, setModelIdProperty: setModelIdProperty, setUpdateMethod: setUpdateMethod, setRequestFormatter: setRequestFormatter, setFlattenItemRoute: setFlattenItemRoute, setValidateOnSync: setValidateOnSync, setIsArray: setIsArray}}
         */ {
          return {
            /**
